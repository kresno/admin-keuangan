<div class="row">
  ...
  <div class="col-lg-4 col-xs-6">
    <div class="small-box bg-yellow">
      ...
      <a href="<?php echo base_url('Pptk') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
    </div>
  </div>
  ...
  <div class="col-lg-6 col-xs-12">
    <div class="box box-info">
      <div class="box-header with-border">
        ...
        <h3 class="box-title">Statistik <small>Data Anggaran Per Program</small></h3>
  ...
  <!-- <div class="col-lg-6 col-xs-12">
    <div class="box box-primary">
      <div class="box-header with-border">
        <i class="fa fa-briefcase"></i>
        <h3 class="box-title">Statistik <small>Data Realisasi</small></h3>
